<li class="block-2">
    ...
    <div class="block-2__desc-wrapper">
        ...
        <span class="product-prices">
            <s class="price-without-discount  text-montserrat-bold-14-upper  grey-959596">
              <span class="">$</span>
              <span class=""><?php echo $block_2_data -> block_2['product-price-without-discount']; ?></span>
            </s>
            <span class="price-with-discount  text-montserrat-bold-18-upper  black-000000">
              <span class="">$</span>
              <span class=""><?php echo $block_2_data -> block_2['product-price-with-discount']; ?></span>
            </span>
        </span>
    </div>
</li>