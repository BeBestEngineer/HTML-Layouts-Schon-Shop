<nav class="navbar  navbar-default  main-navbar  text-myriad-pro-regular-14-upper  black-252528">
    ...
    <div class="row">
      <div class="col-lg-2  col-sm-2">
        ...
        <div class="collapse  navbar-collapse" style="position: static;" id="bs-example-navbar-collapse-1">
          ...
          <!--Login-->
          <li>
            <a role="button" data-toggle="modal" data-target=".login-modal">
              <svg width="20" height="20" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
  ...
  <!--        <li><a href="#">Link</a></li>-->
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
              <span class="main-navbar__vertical-allign">Products lists</span>
              <svg  class="main-navbar__vertical-allign" width="20" height="20" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                <path d="M1395 736q0 13-10 23l-466 466q-10 10-23 10t-23-10l-466-466q-10-10-10-23t10-23l50-50q10-10 23-10t23 10l393 393 393-393q10-10 23-10t23 10l50 50q10 10 10 23z"></path>
              </svg>
            </a>
            <ul class="dropdown-menu  products-lists__dropdown-menu">
              ...
              <li role="separator" class="divider"></li>
                <li><a href="?page=products-list">Appliances</a></li>
                <li><a href="?page=products-list">Lighting</a></li>

              <li role="separator" class="divider"></li>
                <li><a href="?page=products-list">Sofas & Beds</a></li>
                <li><a href="?page=products-list">Chairs, stools & benches</a></li>
                <li><a href="?page=products-list">Tables</a></li>

              <li role="separator" class="divider"></li>
                <li><a href="?page=products-list">Small storage & organisers</a></li>
            </ul>
          </li>

          <li><a href="?page=product">Product page</a></li>
        ...
        <div>
          ...
          <ul class="nav  nav-tabs  nav-justified" role="tablist">
            <li role="presentation" class="active">
              <a class="text-montserrat-regular-18-upper  grey-757575" href="#sign-in" aria-controls="home" role="tab" data-toggle="tab">Sign in</a>
            </li>
            <li role="presentation">
              <a class="text-montserrat-regular-18-upper  grey-757575" href="#create-account" aria-controls="profile" role="tab" data-toggle="tab">Create new account</a>
            </li>
          </ul>
