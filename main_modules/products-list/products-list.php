  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-9">
        ...
        <div class="row  text-myriad-pro-regular-14  grey-a5a5a5">
          <div class="col-lg-4">
        ...
        <div class="row">
          <ul class="pagination-1">
            <li class="pagination-1__item-last" style="visibility: hidden"><a class="pagination-1__item-link  text-montserrat-bold-16-cap  grey-757575" href="#">&laquo;</a></li>
            <li class="pagination-1__item active"><a class="pagination-1__item-link  text-montserrat-bold-16-cap  grey-757575" href="#">1</a></li>
            <li class="pagination-1__item"><a class="pagination-1__item-link  text-montserrat-bold-16-cap  grey-757575" href="#">2</a></li>
            <li class="pagination-1__item"><a class="pagination-1__item-link  text-montserrat-bold-16-cap  grey-757575" href="#">3</a></li>
            <li class="pagination-1__item"><a class="pagination-1__item-link  text-montserrat-bold-16-cap  grey-757575" href="#">4</a></li>
            <li class="pagination-1__item"><a class="pagination-1__item-link  text-montserrat-bold-16-cap  grey-757575" href="#">5</a></li>
            <li class="pagination-1__item-next"><a class="pagination-1__item-link  text-montserrat-bold-16-cap  grey-757575" href="#">&raquo;</a></li>
          </ul>
        </div>
