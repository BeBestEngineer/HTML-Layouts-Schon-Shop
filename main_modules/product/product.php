      ...
      <div class="container-fluid  product__wrapper">
        <div class="container">
          ...
          <div class="col-md-6">
            ...
            <div class="product__header">
              ...
              <div class="product__actions">
                <a href="#" class="product__actions-link">
                  <svg  class="product__info-icon" width="20" height="20" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M1344 1024q133 0 226.5 93.5t93.5 226.5-93.5 226.5-226.5 93.5-226.5-93.5-93.5-226.5q0-12 2-34l-360-180q-92 86-218 86-133 0-226.5-93.5t-93.5-226.5 93.5-226.5 226.5-93.5q126 0 218 86l360-180q-2-22-2-34 0-133 93.5-226.5t226.5-93.5 226.5 93.5 93.5 226.5-93.5 226.5-226.5 93.5q-126 0-218-86l-360 180q2 22 2 34t-2 34l360 180q92-86 218-86z"/></svg>
                  <span class="product__info-text  text-montserrat-regular-14-upper  grey-b6b6b6">Share</span>
                </a>
                <a href="#" class="product__actions-link">
                  <svg  class="product__info-icon" width="20" height="20" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M1792 1184v192q0 13-9.5 22.5t-22.5 9.5h-1376v192q0 13-9.5 22.5t-22.5 9.5q-12 0-24-10l-319-320q-9-9-9-22 0-14 9-23l320-320q9-9 23-9 13 0 22.5 9.5t9.5 22.5v192h1376q13 0 22.5 9.5t9.5 22.5zm0-544q0 14-9 23l-320 320q-9 9-23 9-13 0-22.5-9.5t-9.5-22.5v-192h-1376q-13 0-22.5-9.5t-9.5-22.5v-192q0-13 9.5-22.5t22.5-9.5h1376v-192q0-14 9-23t23-9q12 0 24 10l319 319q9 9 9 23z"/></svg>
                  <span class="product__info-text  text-montserrat-regular-14-upper  grey-b6b6b6">Share</span>
                </a>
                <a href="#" class="product__actions-link">
                  <svg  class="product__info-icon" width="20" height="20" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M896 1664q-26 0-44-18l-624-602q-10-8-27.5-26t-55.5-65.5-68-97.5-53.5-121-23.5-138q0-220 127-344t351-124q62 0 126.5 21.5t120 58 95.5 68.5 76 68q36-36 76-68t95.5-68.5 120-58 126.5-21.5q224 0 351 124t127 344q0 221-229 450l-623 600q-18 18-44 18z"/></svg>
            ...
            <div class="product__desc  text-source-sans-pro-light-16  grey-696969  text-justify">
              <p class="desc">
              ...
              <div class="product__bittons">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <button class="product__add-to-basket-button  product__info-text  text-montserrat-bold-14-upper  white-ffffff  red-f46060-bg" type="button">Add to cart</button>
                  </div>
                </div>
              </div>
            </div>
