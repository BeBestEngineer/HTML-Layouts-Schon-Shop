<main class="home">
          ...
          <div class="carousel-inner" role="listbox">
            ...
            <div class="item active"><!--сделаnm вместо div ссылку-->
              ...
              <div class="carousel-caption carousel-1-text">
                ...
                <p class="text-source-sans-pro-light-16-it  grey-838182">Consectetur adipisicing elit. Beatae accusamus,<br> optio, repellendus inventore </p>
  ...
  <div class="container">
    ...
    <section class="masonry-4-grid-1">
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="masonry-4-grid-1__item-1">
            ...
            <h3 class="text-source-sans-pro-light-24-up-ls-2  grey-696969">My smal writting desk</h3>
            <a class="masonry-4-grid-1__action-link" href="#">
              <span class="text-montserrat-bold-14-upper  grey-868686">Shop now</span>
        ...
        <div class="col-lg-4">
          <div class="row">
            <div class="col-lg-12">
              <div class="masonry-4-grid-1__item-2">
  ...
  <div class="container">
    <section class="carousel-1-4_2">
      ...
      <a class="products-category-link  text-montserrat-regular-18-upper  black-3a3a3a  active" href="#">Featured</a>
      <a class="products-category-link  text-montserrat-regular-18-upper  grey-868686" href="#">Latest</a>
      <a class="products-category-link  text-montserrat-regular-18-upper  grey-868686" href="#">Best Seller</a>


      <ul class="item carousel-1-4_2-container" id="carousel-1-4_2-container">

        <?php for ($i = 0; $i <= 10; ++$i): ?>
        <li class="item carousel-1-4_2-container__item">
          <div class="">
  ...
  <div class="container">
    <section class="carousel-2-4 text-center">
      ...
      <p class="text-source-sans-pro-semibold-14-up-ls-2  grey-a0a0a0">Excepteur sint occaecat</p>


      <ul class="carousel-2-4-container" id="carousel-2-4-container">

        <?php for ($i = 0; $i <= 11; ++$i): ?>
        <li class="item carousel-2-4-container__item">
    ...
    <div class="row">
      ...
      <article class="col-lg-3">
        <div class="featured-products">
          <h2 class="text-montserrat-bold-20-cap  black-3a3a3a">Featured products</h2>
