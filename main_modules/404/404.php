<main class="page-404 text-center">
  <h1 class="page-404__title  text-montserrat-bold-200-upper  black-545454">404</h1>
  ...
  <div class="page-404__form-wrapper">
      ...
      <form class="page-404__form  form-inline" id="page-404-form">
        <input type="text" class="form-control  page-404__form-input  text-montserrat-regular-16-upper  black-545454" id="" name="" placeholder="Search">
        <button type="submit" class="page-404__form-button">
